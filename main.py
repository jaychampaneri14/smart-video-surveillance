...
Motion detection, tracking, and alert system for security cameras
...
def main():
    print("=" * 65)
    print(f"  Smart Video Surveillance")
    print("=" * 65)
    print(f"  Motion detection, tracking, and alert system for security cameras")
    print()
